...
function AuthIllustrationSet() {
  ...
  return (
    <div className='relative h-full w-full overflow-hidden'>
      ...
      />
      <div className='absolute inset-0 bg-gradient-to-br from-sky-900/45 via-slate-900/25 to-orange-500/20' />
      <div
      ...
      <div className='relative h-full w-full p-6 sm:p-10 flex flex-col justify-end'>
        <div className='max-w-xl rounded-2xl bg-white/80 backdrop-blur-sm p-5 sm:p-6 shadow-lg border border-white/60'>
          <div className='inline-flex h-10 w-10 items-center justify-center rounded-xl bg-orange-500 text-white mb-3'>
