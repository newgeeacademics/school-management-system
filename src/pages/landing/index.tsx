...
function NavAnchor({
  ...
  return (
    <a
      href={href}
      onClick={handleClick}
      className='text-sm font-medium text-gray-700 hover:text-orange-600 transition-colors shrink-0'
    >
      {children}
    </a>
  );
    ...
    <div className='min-h-[100dvh] min-h-svh flex flex-col bg-gradient-to-b from-gray-50 to-white overflow-x-hidden relative'>
      ...
      >
        <div className='container mx-auto flex h-14 sm:h-16 items-center justify-between gap-3 px-4 sm:px-5 md:px-6 max-w-7xl'>
          <Link
            to='/'
            className='font-bold text-base sm:text-lg md:text-xl text-gray-900 truncate hover:text-orange-600 transition-colors'
          >
            {t('landing.brandName')}
          </Link>
      ...
      <main className='flex-1 pt-14 sm:pt-16'>
            ...
            <div className='text-center lg:text-left'>
              ...
              <div className='mt-8 sm:mt-10 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start'>
                <Button
                  asChild
                  size='lg'
                  className='bg-orange-500 hover:bg-orange-600 text-white h-12 px-6 sm:px-8 text-base'
                >
                  <Link to='/register'>
                    {t('landing.heroCta')}
        ...
        <section
          id='scan-securite'
          className='scroll-mt-[4.5rem] border-t border-gray-200/80 bg-gradient-to-br from-orange-50/80 to-white py-12 sm:py-16 md:py-20'
        >
        ...
        <section className='py-12 sm:py-16 md:py-20 border-t border-gray-200/80'>
          <div className='container mx-auto px-4 sm:px-5 md:px-6 text-center max-w-7xl'>
            ...
            <Button asChild size='lg' className='bg-orange-500 hover:bg-orange-600 text-white h-12 px-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10'>
            ...
            <div>
              ...
              <ul className='space-y-2 text-sm text-gray-600'>
                <li>
                  ...
                  <a href='tel:+2250555965862' className='hover:text-orange-600 transition-colors'>
                    +225 05 55 96 58 62
                  </a>
                </li>
                <li>
                  <span className='text-gray-500 block text-xs'>{t('landing.footerEmailLabel')}</span>
                  <a href='mailto:contact@newgeeacademy.com' className='hover:text-orange-600 transition-colors break-all'>
            ...
            <div>
              ...
              <ul className='space-y-2 text-sm'>
                <li>
                  <a href='#cgu' onClick={(e) => { e.preventDefault(); scrollToSection('#cgu'); }} className='text-gray-600 hover:text-orange-600 transition-colors'>
                    {t('landing.footerCgu')}
                  </a>
                </li>
                <li>
                  <a href='#mentions-legales' onClick={(e) => { e.preventDefault(); scrollToSection('#mentions-legales'); }} className='text-gray-600 hover:text-orange-600 transition-colors'>
                    {t('landing.footerLegal')}
                  </a>
                </li>
                <li>
                  <a href='mailto:contact@newgeeacademy.com?subject=Support%20NewGee' className='text-gray-600 hover:text-orange-600 transition-colors'>
            ...
            <div>
              ...
              <div className='flex items-center gap-3 text-gray-500'>
                <a
                  ...
                  className='hover:text-orange-600 transition-colors p-1'
                  aria-label='LinkedIn'
                >
...
function PresentationRow({
  ...
  const textBlock = (
    <div className='min-w-0'>
      <p className='text-sm font-semibold text-orange-600 uppercase tracking-wide mb-2'>{eyebrow}</p>
        ...
        <div className='h-full flex flex-col bg-gradient-to-b from-sky-100 to-white'>
          <div className='h-[45%] bg-gradient-to-br from-emerald-100 via-sky-50 to-sky-100 relative p-3'>
            <div className='absolute inset-3 rounded-xl bg-white/90 border border-sky-200/80 shadow-inner overflow-hidden'>
              ...
              <div className='relative h-[calc(100%-1.5rem)] bg-gradient-to-br from-sky-100 to-emerald-50'>
                ...
                <div className='absolute left-[42%] top-[38%] flex items-center justify-center w-8 h-8 rounded-full bg-orange-500 text-white shadow-lg'>
          ...
          <div className='flex-1 p-3 space-y-2'>
            ...
            <div className='space-y-1.5'>
              {['Mathématiques', 'Français', 'Sciences'].map((label, i) => (
                <div key={label} className='flex justify-between items-center text-[11px] bg-white rounded-lg px-2 py-1.5 border border-gray-100 shadow-sm'>
                  ...
                  <span className='font-semibold text-orange-600 tabular-nums'>{14 + i}/20</span>
                </div>
              ))}
            </div>
          </div>
  ...
  return (
    <div className='w-full h-full min-h-[200px] relative flex items-center justify-center bg-gradient-to-br from-sky-50 to-emerald-50 rounded-xl border border-sky-100'>
      <svg viewBox='0 0 200 140' className='w-[90%] max-w-[280px] h-auto' aria-hidden>
        ...
        <circle cx='100' cy='68' r='4' fill='#f97316' />
        <g transform='translate(88 56)'>
          <rect x='0' y='4' width='24' height='16' rx='3' fill='#ea580c' />
...
function AttendanceIllustration() {
  const { t } = useTranslation();
  const rows = ['Kouassi A.', 'Traoré M.', 'Yao K.', 'Koné S.'];
  return (
...
function AdminIllustration() {
  ...
  return (
    <div className='w-full h-full min-h-[200px] grid grid-cols-5 gap-3 p-4'>
      <div className='col-span-3 flex flex-col justify-end gap-2 rounded-xl bg-gradient-to-t from-orange-50 to-white border border-orange-100 p-3'>
        <p className='text-xs font-medium text-gray-500'>{t('landing.mockupPayments')}</p>
        <div className='flex items-end gap-1.5 h-24'>
          {[40, 65, 45, 80, 55, 90].map((h, i) => (
            <div
              key={i}
              className='flex-1 rounded-t bg-gradient-to-t from-orange-500 to-orange-400 opacity-90'
              style={{ height: `${h}%` }}
            />
          ))}
        </div>
          ...
          {Array.from({ length: 28 }, (_, i) => (
            <div
              ...
              className={`aspect-square rounded text-[8px] flex items-center justify-center ${
                i === 12 ? 'bg-orange-500 text-white font-bold' : 'bg-gray-50 text-gray-600'
              }`}
            >
              {i + 1}
            </div>
...
function QrScanIllustration() {
  const { t } = useTranslation();
  return (
    <div className='relative rounded-2xl border-2 border-dashed border-orange-300 bg-white p-8 shadow-lg max-w-sm'>
      <QrCode className='h-32 w-32 sm:h-40 sm:w-40 text-gray-900 mx-auto' strokeWidth={1} />
      <div className='absolute -bottom-3 left-1/2 -translate-x-1/2 bg-orange-500 text-white text-xs font-semibold px-3 py-1 rounded-full shadow-md'>
