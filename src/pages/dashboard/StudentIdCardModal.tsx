      ...
      <div className='id-card-body flex gap-3 px-4 py-3'>
        ...
        <div className='min-w-0 flex-1'>
          ...
          <p className='id-card-number mt-1.5 font-mono text-[11px] text-foreground'>
            N° carte : <strong>{card.idCardNumber || card.matricule}</strong>
          </p>
        </div>
      </div>
    ...
    <Sheet open={open} onOpenChange={(v) => !v && onClose()}>
      <SheetContent side='right' className='sm:max-w-md'>
        <SheetHeader>
          ...
          <SheetDescription>
            Carte d&apos;identification avec QR code. Les contacts parent et enseignant figurent
            dans l&apos;export Word (liste complète).
          </SheetDescription>
        </SheetHeader>
