...
export function EnvConfigBanner() {
  ...
  return (
    ...
    >
      Configuration incomplète : définissez <strong>VITE_ADMIN_APP_URL</strong> et{' '}
      <strong>VITE_USER_PORTAL_URL</strong> sur Vercel, puis redéployez le site principal.
    </div>
  );
}
