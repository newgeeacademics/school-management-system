    ...
    >
      ...
      >
        <div className={cn('relative z-10', isEmbedded ? '' : 'px-0')}>
          {!isEmbedded ? <AppLogo className='mb-6' name='NewGee Admin' /> : null}
          <h1
            className={cn(
              'font-bold tracking-tight text-slate-900',
              isEmbedded ? 'auth-page__title mt-0' : 'text-3xl mb-2 text-gradient-blue'
            )}
          >
            {t('auth.welcomeBack')}
          </h1>
          <p
            className={cn(
              ...
              isEmbedded ? 'auth-page__subtitle' : 'text-base text-gray-700'
            )}
          >
        ...
        <div className={cn('relative z-10', isEmbedded ? 'auth-page__form' : 'mt-6')}>
          <form onSubmit={onSubmit} className={isEmbedded ? 'contents' : 'space-y-6'}>
